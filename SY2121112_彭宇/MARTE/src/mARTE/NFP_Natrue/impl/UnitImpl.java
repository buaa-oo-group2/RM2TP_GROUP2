 ...
 * </p>
 * <ul>
 *   <li>{@link mARTE.NFP_Natrue.impl.UnitImpl#getConvFactor <em>Conv Factor</em>}</li>
 *   <li>{@link mARTE.NFP_Natrue.impl.UnitImpl#getConvOffset <em>Conv Offset</em>}</li>
 *   <li>{@link mARTE.NFP_Natrue.impl.UnitImpl#getBaseUnit <em>Base Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitImpl extends MinimalEObjectImpl.Container implements Unit {
	...
	protected EClass eStaticClass() {
		return NFP_NatruePackage.Literals.UNIT;
	}
	...
	public void setConvFactor(Double newConvFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NFP_NatruePackage.UNIT__CONV_FACTOR, oldConvFactor, convFactor));
	}
	...
	public void setConvOffset(Double newConvOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NFP_NatruePackage.UNIT__CONV_OFFSET, oldConvOffset, convOffset));
	}
	...
	public Unit getBaseUnit() {
		if (baseUnit != null && baseUnit.eIsProxy()) {
			...
			if (baseUnit != oldBaseUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NFP_NatruePackage.UNIT__BASE_UNIT, oldBaseUnit, baseUnit));
			}
		}
		return baseUnit;
	}
	...
	public void setBaseUnit(Unit newBaseUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NFP_NatruePackage.UNIT__BASE_UNIT, oldBaseUnit, baseUnit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NFP_NatruePackage.UNIT__CONV_FACTOR:
				return getConvFactor();
			case NFP_NatruePackage.UNIT__CONV_OFFSET:
				return getConvOffset();
			case NFP_NatruePackage.UNIT__BASE_UNIT:
