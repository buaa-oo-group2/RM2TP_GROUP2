...
public class AllocationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AllocationsPackage.EXECUTION_PLATFORM_ALLOCATION_END: {
				...
				if (result == null) result = caseAllocationEnd(executionPlatformAllocationEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AllocationsPackage.APPLICATION_ALLOCATION_END: {
				...
				if (result == null) result = caseAllocationEnd(applicationAllocationEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AllocationsPackage.ALLOCATION: {
				Allocation allocation = (Allocation)theEObject;
				T result = caseAllocation(allocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AllocationsPackage.ALLOCATION_END: {
			...
			case AllocationsPackage.REFINEMENT: {
