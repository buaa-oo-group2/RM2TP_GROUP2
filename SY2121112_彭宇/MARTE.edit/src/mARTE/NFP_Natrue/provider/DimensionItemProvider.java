...
/**
 * This is the item provider adapter for a {@link mARTE.NFP_Natrue.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NFP_NatruePackage.Literals.DIMENSION__SYMBOL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Basequantity feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBasequantityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_basequantity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_basequantity_feature", "_UI_Dimension_type"),
				 NFP_NatruePackage.Literals.DIMENSION__BASEQUANTITY,
				 true,
				 false,
				 true,
				 null,
