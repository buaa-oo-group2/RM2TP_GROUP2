...
/**
 * This is the item provider adapter for a {@link mARTE.NFP_Natrue.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NFP_NatruePackage.Literals.UNIT__CONV_FACTOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NFP_NatruePackage.Literals.UNIT__BASE_UNIT,
				 true,
				 false,
				 true,
				 null,
