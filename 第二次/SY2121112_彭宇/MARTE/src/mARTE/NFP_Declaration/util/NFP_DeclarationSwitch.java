 ...
 * @generated
 */
public class NFP_DeclarationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NFP_DeclarationPackage.NFP: {
				NFP nfp = (NFP)theEObject;
				T result = caseNFP(nfp);
				if (result == null) result = caseValueProperty(nfp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NFP_DeclarationPackage.VALUE_TYPE: {
				ValueType valueType = (ValueType)theEObject;
				T result = caseValueType(valueType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NFP_DeclarationPackage.VALUE_PROPERTY: {
				ValueProperty valueProperty = (ValueProperty)theEObject;
				T result = caseValueProperty(valueProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NFP_DeclarationPackage.NFP_TYPE: {
				NFP_Type nfP_Type = (NFP_Type)theEObject;
				T result = caseNFP_Type(nfP_Type);
				if (result == null) result = caseValueType(nfP_Type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
