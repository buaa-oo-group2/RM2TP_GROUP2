 ...
 * </p>
 * <ul>
 *   <li>{@link mARTE_TIME.impl.TimedInstantObservationImpl#getObsKind <em>Obs Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimedInstantObservationImpl extends TimedObservationImpl implements TimedInstantObservation {
	...
	protected EClass eStaticClass() {
		return MARTE_TIMEPackage.Literals.TIMED_INSTANT_OBSERVATION;
	}
	...
	public void setObsKind(EventKind newObsKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MARTE_TIMEPackage.TIMED_INSTANT_OBSERVATION__OBS_KIND,
					oldObsKind, obsKind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MARTE_TIMEPackage.TIMED_INSTANT_OBSERVATION__OBS_KIND:
			return getObsKind();
		}
