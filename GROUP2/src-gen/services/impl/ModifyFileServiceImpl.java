...
public class ModifyFileServiceImpl implements ModifyFileService, Serializable {
	...
	@SuppressWarnings("unchecked")
	public String getComment(int fileId) throws PreconditionException, PostconditionException, ThirdPartyServiceException {
	...
	static {opINVRelatedEntity.put("getComment", Arrays.asList("File"));}
